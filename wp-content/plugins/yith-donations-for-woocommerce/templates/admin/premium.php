    ...
    <div class="seven section section-even clear">
        <div class="landing-container">
            ...
            <div class="col-2">
                ...
                <p>
                    <?php echo sprintf( __('With the %1$sYITH Donations for WooCommerce - Form%2$s widget, you will be free to show in sidebars the total amount of your users\' donations.Share with your followers a significant information that may be always more surprising.','yith-wcaf'),'<b>','</b>'); ?>
                </p>
            </div>
        </div>
    </div>
