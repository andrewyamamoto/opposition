...
<div class="ywcds_form_container">
    <form id="ywcds_add_donation_form" method="get">
        <div class="ywcds_amount_field">
            <label for="ywcds_amount"><?php echo $project;?></label>
        ...
        <div class="ywcds_button_field">
            ...
            <input type="submit" name="ywcds_submit_widget" class="ywcds_submit_widget <?php echo $button_class;?>" value="<?php _e( 'Add donation', 'yith-donations-for-woocommerce' );?>" />
        </div>
    </form>
