			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class='form-group'>
						...
						<input type="text" class="form-control" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit btn btn-primary"><?php _e( 'Submit', 'bbpress' ); ?></button>
